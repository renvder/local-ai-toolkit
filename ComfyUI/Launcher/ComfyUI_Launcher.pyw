...
class ComfyLauncher(tk.Tk):
    ...
    def _build_ui(self):
        ...
        self._btn_start = self._make_btn(btn_row, "▶  Standard Launch", ACCENT, self._start_comfy)
        self._btn_start.pack(side="left", padx=(0, 6))
        self._btn_start_adv = self._make_btn(btn_row, "▶  Disable API Nodes", "#6e40c9", self._start_comfy_adv)
        ...
        self._btn_upd_comfy = self._make_btn(btn_row, "↑  Update ComfyUI", AMBER, self._update_comfyui)
        self._btn_upd_comfy.pack(side="left", padx=(0, 8))
        self._btn_upd_ext = self._make_btn(btn_row, "↑  Update All Extensions", AMBER, self._update_extensions)
