...
| VAE | `flux2-vae.safetensors` | [Hugging Face](https://huggingface.co/VAST-AI/TripoSplat/resolve/main/vae/flux2-vae.safetensors) / [Civitai](https://...) | `ComfyUI/models/vae` | Flux 2 VAE |
